  ...
  return (
    <>
      <form onSubmit={submit} className="space-y-6">
        {/* Main 3-column grid for business, customer, and summary */}
        ...
        {/* 🔸 Full-width Quotation Information */}
        <div className="card w-full">
          <h3 className="text-lg font-semibold mb-3">Quotation Information</h3>
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            placeholder={settings?.defaultNote || "Add a note..."}
          />
        </div>
      </form>
    </>
